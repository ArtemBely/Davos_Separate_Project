...
import oraclesPlanch from '../../public/images/Group 492 — копия.jpg';
import opaclesBigPhone from '../../public/images/Group 492 — копия 2.jpg';
import oraclesSmallPhone from '../../public/images/Mask Group.png';
              ...
              <div className="when" id="why_to">
                  ...
                  <div className='when4'>
                     ...
                     <p className='when_text why2'>For the first time in Davos you’ll be able
                      to become a part of a historical mixed reality event. EmTech Metaverse
                        is opening its space for Davos guests. All correlated activities and special
